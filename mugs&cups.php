...
?>
<?php
    $result=mysql_query("SELECT * FROM posts WHERE post_categories='mugs_cups' and  post_subcategories='cups_saucers'");
...
<div class="ac">
      ...
      <h5 style="margin-left:20%; margin-top:1%"><?php echo $row['post_content'];?></h5>
