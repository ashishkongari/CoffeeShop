			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="themes/images/ladies/kl.jpg"></a>												
								</div>
							<div class="span5">
								<address>
									<strong>Name:</strong> <span>Stovetop Espresso</span><br>
									<strong>Product Code:</strong> <span>Product 2</span><br>
									<strong>Reward Points:</strong> <span>0</span><br>
									<strong>Availability:</strong> <span>Out Of Stock</span><br>								
								</address>									
								<h4><strong>Price: Rs499</strong></h4>
							</div>
							<div class="span5">
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home"> Aromatic coffee percolates instantly with this snazzy Italian style stainless steel espresso maker. It's easy to use and the perfect gift for your friends, family, or even yourself.
Category : Stovetop Espresso Maker Material </div>
									<div class="tab-pane" id="profile">
										<table class="table table-striped shop_attributes">	
											<tbody>
												<tr class="">
													<th>Dimension: Height</th>
													<td>14.5 cm Diameter : 8 cm (at bottom)</td>
												</tr>		
												<tr class="alt">
													<th>Stainless Steel Size</th>
													<td>2 Cups Capacity: 140ml</td>
												</tr>
											</tbody>
										</table>
									</div>
