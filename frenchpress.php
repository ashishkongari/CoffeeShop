...
?>
<?php
    $result=mysql_query("SELECT * FROM posts WHERE post_categories='mugs_cups' and  post_subcategories='cool_mugs'");
...
<div class="ac">
      ...
      <h5 style="margin-left:22%; margin-top:-2%"><?php echo $x='Rs.'.$row['post_price'];?></h5>
